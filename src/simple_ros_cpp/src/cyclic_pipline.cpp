...
public:
    ...
    // Getter 메서드 추가
    rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr getPublisher() const
    {
        return _pub;
    }

private:
    rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr _pub; // private
...
int main(int argc, char *argv[])
{
    ...
    // getter 메서드 사용
    pipe1->getPublisher()->publish(std::move(msg));
